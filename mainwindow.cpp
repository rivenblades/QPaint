...
//    setCentralWidget(ui->paintArea);
    ...
    ui->colorWheel->paintArea = ui->paintArea;
    connect(ui->colorWheel,SIGNAL(colorChange(const QColor)),
                     ui->paintArea,SLOT(setColorFromWheel(const QColor)));
    //    ui->MainLayout->insertWidget(0,ui->paintArea);
//    ui->MainLayout->insertWidget(1,layersContainer);
}
...
void MainWindow::open()
{
    ...
    if (maybeSave()) {
        ...
        // it in the ui->paintArea
        if (!fileName.isEmpty())
            ui->paintArea->openImage(fileName);
    }
}
...
void MainWindow::penColor()
{
    ...
    QColor newColor = QColorDialog::getColor(ui->paintArea->penColor());

    // If a valid color set it
    if (newColor.isValid())
        ui->paintArea->setPenColor(newColor);
}
...
void MainWindow::penWidth()
{
    ...
    int newWidth = QInputDialog::getInt(this, tr("Scribble"),
                                        tr("Select pen width:"),
                                        ui->paintArea->penWidth(),
                                        1, 50, 1, &ok);
    // Change the pen width
    if (ok)
        ui->paintArea->setPenWidth(newWidth);
}
...
//    connect(printAct, SIGNAL(triggered()), ui->paintArea, SLOT(print()));
...
bool MainWindow::saveFile(const QByteArray &fileFormat)
{
    ...
    if (fileName.isEmpty()) {
        ...
        return ui->paintArea->saveImage(fileName, fileFormat.constData());
    }
}
...
{
    ui->paintArea->setMyPenWidth(value);
}

void MainWindow::on_checkBox_2_toggled(bool checked)
{
    ui->paintArea->bHAxisEnabled = checked;
    ui->paintArea->update();
}

void MainWindow::on_checkBox_3_toggled(bool checked)
{
    ui->paintArea->bVAxisEnabled = checked;
    ui->paintArea->update();
}

void MainWindow::on_toolButton_clicked()
{
    ui->paintArea->setMyPenColor(Qt::blue);
}

void MainWindow::on_toolButton_2_clicked()
{
    ui->paintArea->setMyPenColor(ui->paintArea->getBackgroundColor());

}

void MainWindow::on_toolButton_3_clicked()
{
    ui->paintArea->setBackgroundColor(ui->colorWheel->color());
    ui->paintArea->clearImage();
}
